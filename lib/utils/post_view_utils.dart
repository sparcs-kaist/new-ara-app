...
class ArticleController {
  ...
  Future<bool> delete() async {
    ...
    try {
      await userProvider.createDioWithHeadersForPost().delete(apiUrl);
      return true;
  ...
  Future<bool> handleBlock(bool block) async {
    ...
    try {
      await userProvider.createDioWithHeadersForPost().post(
        apiUrl,
...
class FileController {
  ...
  Future<bool> _downloadFile(String uri, String totalPath) async {
    try {
      await userProvider.createDioWithHeadersForPost().download(uri, totalPath);
    } catch (error) {
      return false;
    }
    return true;

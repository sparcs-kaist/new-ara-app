...
class FreeBullentinBoardPage extends StatefulWidget {
  const FreeBullentinBoardPage({Key? key}) : super(key: key);

  @override
  State<FreeBullentinBoardPage> createState() => _FreeBullentinBoardPageState();
}

class _FreeBullentinBoardPageState extends State<FreeBullentinBoardPage> {

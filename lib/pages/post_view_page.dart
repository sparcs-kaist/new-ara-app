      ...
      children: [
        ...
        Row(
          children: [
            ...
            // TODO: 익명 차단이 정식으로 나오면 변경해야함 (현재 코드는 iOS 리젝을 피하기 위한 것)
            // 실명 글인 경우 차단 버튼이 표시되지 않음
            if (_article.is_mine == false && _article.name_type != 4)
              InkWell(
                onTap: () async {
                  if (Platform.isIOS && _article.name_type == 2) {
                    await showDialog(
                      context: context,
